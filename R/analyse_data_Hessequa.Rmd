...
There were also 50 species in the unstructured data that were not in the SABAP2 data. This was due to various issues, including missidentifications.
...
Above will not work as as grid (pentads) is custom, cannot map results. Below mapped richness using other methods.
...
Above will not work as as grid (pentads) is custom, cannot map results but can look at change over time
...
It was noted that there were records where species was NA. They were removed below.
...
It was noted that there were a number of species included in the unstructured data that were not in the structured data. This was for a number of reasons including likely misidentifications.
