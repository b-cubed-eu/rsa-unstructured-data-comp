...
Select Hessequa Atlas Area grid cells, data falling into correct time period (2015-2024), and where full protocol was used for surveys (i.e., adhoc records in SABAP2 are removed)
...
```{r}
# subset cube to only include records from Hessequa atlas area and remove NA speciesKey
