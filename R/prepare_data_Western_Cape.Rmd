...
Select data falling into correct time period (2008-2024), and where full protocol was used for surveys (i.e., adhoc records in SABAP2 are removed)
...
The occurrence cube includes data for gridcells falling outside of the Western Cape. Therefore WC cells are selected
...
WCQDGC<-unique(WCSF$qdgccode) # QDGC in Hessequa atlas area
...
Plot shows the grid cells (at pentad resolution) in which birds have been recorded through SABAP2 in the Western Cape.
