...
Total of 1 599 485 observations. Less than from the SABAP2 data
...
614 bird species recorded, of which 139 were recorded < 10 times (very rare), 124 were recorded between 10 and 100 times (rare), 131 were recorded between 100 and 1000 times (common), 168 were recorded between 1000 and 10 000 times, and 52 were recorded more than 10 000 times. 112 more bird species recorded than in SABAP2.
...
- *Anthus nicholsoni* (Nicholson's Pipit) (583 records): Also an accepted species name in GBIF is Anthus similis (Jerdon, 1840), for which the common names are Long-billed pipit (in English) and Nicholsonkoester (in Afrikaans). *Anthus similis* is in the SABAP2 data.

- *Tychaedon coryphoeus* (Karoo scrub-robin) (935 records): Two accepted species names in GBIF (*Tychaedon coryphoeus* (Lesson, 1831) and *Erythropygia coryphoeus* (Vieillot, 1817)). Appears in SABAP2 under *Erythropygia coryphoeus*.

- *Prinia hypoxantha* (Drakensberg Prinia) (1114 records). Likely missidentifications. Species does not occur in Western Cape.

- *Sylvia layardi* (Layard's Warbler) (1236 records). On SABAP2 website appears under the synonym '*Curruca layardi* (Hartlaub, 1862)', but the species is not under this name in SABAP2 data downloaded from GBIF.
...
- *Curruca subcoerulea* (Chestnut-vented Warbler) (2130 records): Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.

- *Dessonornis caffer* (Cape Robin-Chat) (2447 records): Cape Robin-Chat appears to have two accepted species names in GBIF (*Cossypha caffra* (Linnaeus, 1771) and *Dessonornis caffer* (Linnaeus, 1771)). It is under *Cossypha caffra* in SABAP2.

- *Macronyx capensis* (Cape Longclaw) (2893 records): Area is part of range. Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.

- *Upupa epops* (Hoopoe) (3069 records): two accepted species names in GBIF (*Upupa epops* Linnaeus, 1758 and *Upupa africana* Bechstein, 1811). The species appears under the name *Upupa africana* in SABAP2 data.
...
- *Buteo buteo* (buzzard) (4045 records). Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.

- *Euplectes capensis* (yellow bishop) (9197 records). Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.

- *Phoenicopterus roseus* (greater flamingo) (9229 records): Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.
...
- *Zosterops virens* (Cape white-eye) (26427 records): two accepted names in GBIF (*Zosterops virens* Sundevall, 1850 and *Zosterops capensis* Sundevall, 1850). Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.
...
Many species have relatively high percentage range overlap, most have > 50% overlap (31 have < 10% overlap). 63 species have 100 % overlap, most are a rare/very rare species.
...
For the early time periods most species have relatively low percentage range overlap - at ~50% or below. But there is an increase over time in this percentage, as more unstructured data becomes available, and so in the later time periods most species have higher percentage range overlap.
...
There are 115 species in the unstructured data that are not in the SABAP2 data. For 98 there are < 65 records. The 17 species with > 65 records are the same species as discussed above. Reasons are discussed above. All comparisons below are based on the species in SABAP2.
...
Correlation is negative for most species, in partularly for very common and extremely common species.
...
Poor, mostly negative correlations for common, very common, and extremely common species
...
Correlations improve when observations are binned into time periods.
...
The uncorrected results for the time-period appear to be slightly better.
...
K value  = 0.2454, so there is a 'fair' agreement in trends in number of records over time
