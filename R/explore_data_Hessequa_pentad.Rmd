...
Total of 22250 observations. Less than from the SABAP2 data
...
Number of species varies across pentads. Most have < 50 species, but ~12 have > 100 species.
...
- *Milvus migrans* (Black kite) (46 records): A summer visitor mostly to the north of the country. Possible missidentifications? Can be confused with Yellow-billed kite (*Milvus aegyptius*), which is included in SABAP2

- *Certhilauda curvirostris* (Cape Lark) (58 records): Range restricted species, which does not occur in the area. Possible missidentifications? Maybe confused with 	*Certhilauda brevirostris* (Agulhas lark), which does occur in this area, and is included in the SABAP2 data.

- *Upupa epops* (Hoopoe) (98 records): two accepted species names in GBIF (Upupa epops Linnaeus, 1758 and *Upupa africana* Bechstein, 1811). The species appears under the name *Upupa africana* in SABAP2 data.

- *Buteo buteo* (buzzard) (111 records): A summer visitor, but it is very similar to *Buteo trizonatus* (difficult to tell a part), which is a resident in the area, and is in the SABAP2 data. Possible missidentifications? Note, many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.

- *Psalidoprocne pristoptera* (black saw-wing) (122 records): area is within its range. Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.
...
- *Euplectes capensis* (yellow bishop) (130 records): area is in range. Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.

- *Zosterops virens* (Cape white-eye) (430 records): two accepted name in GBIF (*Zosterops virens* Sundevall, 1850 and *Zosterops capensis* Sundevall, 1850). Area is in range, but it appears under neither name in SABAP2 data. Many records in Western Cape for this species on SABAP2 website, but does not appear in data downloaded from GBIF.
...
Overall we see an overlap of 24.5%
...
265 species appear in both the structured and unstructured datasets, this represents 85% of the species recorded in SABAP2.
...
Of the 310 species in the SABAP2 data (all appear in the period from 2015 to 2022), 265 are in the unstructured data (85%). Of the 265, 37 are very rare, 72 are rare, 123 are common, and 33 very common. Of the 45 species in SABAP2 that are missing from the unstructured data 37 are very rare, 8 are rare, none are common or very common. The percentage of species recorded in the unstructured data increased with commonness: 50% of very rare species were recorded, 90% of rare species were recorded, 100% of common and very common species were recorded.
...
Overall we see a range overlap of 20% (slightly lower than for 2015-2024)
...
Graph shows for each species the degree to which the number of records over time in SABAP2 correlates with number of records in unstructured dataset. The strength and direction of the correlation varies significantly between species, but for most is negative, and for 39 species the correlation is NA.
...
Graph shows for each species the degree to which the number of records over time (based on time periods) in SABAP2 correlates with number of records in unstructured dataset. The strength and direction of the correlation varies significantly between species, and for 38 species the correlation is NA. But, for 27 species correlation > 0.9.
...
Either not strong or no correlation for all groups. Note for most very rare species, many rare species and a few common species correlation was not possible. No pattern in terms of the correlations and commonness.
...
K value  = 0.05447, so there is a 'slight' agreement in trends in number of records over time
...
Kappa value = 0.06446, and so there is a 'slight' agreement in trends in number of records over time
...
Bray curtis index of 0.66 indicates dissimilar species composition
